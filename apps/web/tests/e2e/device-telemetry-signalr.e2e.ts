...
test("Enrollment, live inventory, telemetry, simulated command, audit and heartbeat timeout", async ({ page, playwright }) => {
  ...
  try {
    ...
    await queue.click();
    await expect(page.getByText("Command dispatched.")).toBeVisible();
